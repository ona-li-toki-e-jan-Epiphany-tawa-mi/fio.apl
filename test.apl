...
∇MACRO←CHECK_NEWLINE ASSERT_FGETS EXISTING_FILE_CONTENT_LINE
  ...
  MACRO←MACRO,"⍎ASSERT_R"
∇
∇TEST_FILE_HANDLING; RESULT;FD;CONTENTS;BUFFER;ASSERT_READ;ASSERT_FCLOSE;BYTES_READ
  ...
  BYTES_READ←FD FIO∆FWRITE⍨ FIO∆UTF8_TO_BYTES EXISTING_FILE_CONTENTS
  RESULT←(≢EXISTING_FILE_CONTENTS)≡BYTES_READ ◊ ⍎ASSERT_R
